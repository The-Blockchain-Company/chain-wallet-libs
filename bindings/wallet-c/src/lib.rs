...
///
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_import_keys(
...
/// Don't forget to call `tbco_quibitous_wallet_delete_error` to free
/// the `ErrorPtr` from memory and avoid memory leaks.
///
/// * this function may fail if the wallet pointer is null;
///
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_id(
    wallet: WalletPtr,
    id_out: *mut u8,
) -> ErrorPtr {
...
///
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_spending_counter(
    wallet: WalletPtr,
...
///
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_total_value(
    wallet: WalletPtr,
    total_out: *mut u64,
) -> ErrorPtr {
...
///
/// this is the value retrieved from any quibitous endpoint that allows to query
...
///
#[no_mangle]
pub extern "C" fn tbco_quibitous_wallet_set_state(
    wallet: WalletPtr,
    value: u64,
    counter: u32,
) -> ErrorPtr {
...
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_vote_proposal_new_public(
...
/// unexpected behaviors.
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_vote_proposal_new_private(
    vote_plan_id: *const u8,
    index: u8,
    num_choices: u8,
...
/// `tbco_quibitous_waller_delete_buffer`.
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_vote_cast(
    wallet: WalletPtr,
...
/// unexpected behaviors.
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_symmetric_cipher_decrypt(
    password: *const u8,
...
/// `tbco_quibitous_wallet_delete_string` function.
///
/// This function returns an allocated null terminated pointer. Don't
/// forget to free the memory with: `tbco_quibitous_wallet_delete_string`.
///
/// # Safety
///
/// This function dereference raw pointers. Even though
...
///
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_error_to_string(error: ErrorPtr) -> *mut c_char {
...
///
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_error_details(error: ErrorPtr) -> *mut c_char {
    if let Some(error) = (error as *mut ErrorRust).as_ref() {
...
/// in or you may see unexpected behaviors
///
/// Don't forget to delete the fragment object with `tbco_quibitous_delete_fragment`.
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_fragment_from_raw(
    buffer: *const u8,
    buffer_length: usize,
...
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_fragment_id(
...
///
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_delete_string(ptr: *mut c_char) {
    if !ptr.is_null() {
...
/// in or you may see unexpected behaviors
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_delete_buffer(ptr: *mut u8, length: usize) {
    if !ptr.is_null() {
...
///
#[no_mangle]
pub extern "C" fn tbco_quibitous_wallet_delete_error(error: ErrorPtr) {
...
///
#[no_mangle]
pub extern "C" fn tbco_quibitous_wallet_delete_settings(settings: SettingsPtr) {
...
///
#[no_mangle]
pub extern "C" fn tbco_quibitous_wallet_delete_wallet(wallet: WalletPtr) {
...
///
#[no_mangle]
pub extern "C" fn tbco_quibitous_wallet_delete_proposal(proposal: ProposalPtr) {
...
/// in or you may see unexpected behaviors
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_delete_fragment(fragment: FragmentPtr) {
