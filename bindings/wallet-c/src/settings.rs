...
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_settings_new(
...
///   performed
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_settings_fees(
...
///   performed
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_settings_discrimination(
    settings: SettingsPtr,
...
///   the data it points to is valid
#[no_mangle]
pub unsafe extern "C" fn tbco_quibitous_wallet_settings_block0_hash(
    settings: SettingsPtr,
    block0_hash: *mut u8,
) -> ErrorPtr {
