 ...
 *
 * Copyright 2021-2022 The Blockchain Company.io Ltd
 * Licensed with: MIT OR Apache-2.0
 */

#ifndef TBCO_CHAIN_WALLET_LIBC_
#define TBCO_CHAIN_WALLET_LIBC_
 ...
 *
 */
ErrorPtr tbco_quibitous_block_date_from_system_time(const struct Settings *settings,
                                                      uint64_t date,
 ...
 */
void tbco_quibitous_delete_fragment(FragmentPtr fragment);
 ...
 */
ErrorPtr tbco_quibitous_fragment_from_raw(const uint8_t *buffer,
 ...
 */
ErrorPtr tbco_quibitous_fragment_id(FragmentPtr fragment,
 ...
 *
 */
ErrorPtr tbco_quibitous_max_expiration_date(const struct Settings *settings,
 ...
 * unexpected behaviors.
 */
ErrorPtr tbco_quibitous_symmetric_cipher_decrypt(const uint8_t *password,
 ...
 * unexpected behaviors.
 */
ErrorPtr tbco_quibitous_vote_proposal_new_private(const uint8_t *vote_plan_id,
                                                    uint8_t index,
                                                    uint8_t num_choices,
 ...
 * unexpected behaviors.
 */
ErrorPtr tbco_quibitous_vote_proposal_new_public(const uint8_t *vote_plan_id,
                                                   uint8_t index,
                                                   uint8_t num_choices,
                                                   ProposalPtr *proposal_out);
 ...
 * in or you may see unexpected behaviors
 */
void tbco_quibitous_wallet_delete_buffer(uint8_t *ptr, uintptr_t length);
 ...
 *
 */
void tbco_quibitous_wallet_delete_error(ErrorPtr error);
 ...
 *
 */
void tbco_quibitous_wallet_delete_proposal(ProposalPtr proposal);
 ...
 *
 */
void tbco_quibitous_wallet_delete_settings(SettingsPtr settings);
 ...
 *
 */
void tbco_quibitous_wallet_delete_string(char *ptr);
 ...
 *
 */
void tbco_quibitous_wallet_delete_wallet(WalletPtr wallet);
 ...
 *
 */
char *tbco_quibitous_wallet_error_details(ErrorPtr error);
 ...
 *
 */
char *tbco_quibitous_wallet_error_to_string(ErrorPtr error);
 ...
 *
 */
ErrorPtr tbco_quibitous_wallet_id(WalletPtr wallet,
                                    uint8_t *id_out);
 ...
 *
 */
ErrorPtr tbco_quibitous_wallet_import_keys(const uint8_t *account_key,
 ...
 *
 */
ErrorPtr tbco_quibitous_wallet_set_state(WalletPtr wallet,
                                           uint64_t value,
                                           uint32_t counter);
 ...
 */
ErrorPtr tbco_quibitous_wallet_settings_block0_hash(SettingsPtr settings,
                                                      uint8_t *block0_hash);
 ...
 *   performed
 */
ErrorPtr tbco_quibitous_wallet_settings_discrimination(SettingsPtr settings,
 ...
 *   performed
 */
ErrorPtr tbco_quibitous_wallet_settings_fees(SettingsPtr settings,
 ...
 */
ErrorPtr tbco_quibitous_wallet_settings_new(struct SettingsInit settings_init,
 ...
 *
 */
ErrorPtr tbco_quibitous_wallet_spending_counter(WalletPtr wallet,
 ...
 *
 */
ErrorPtr tbco_quibitous_wallet_total_value(WalletPtr wallet,
                                             uint64_t *total_out);
 ...
 */
ErrorPtr tbco_quibitous_wallet_vote_cast(WalletPtr wallet,
